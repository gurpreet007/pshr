<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_req_retire.ascx.cs" Inherits="retire_request" %>
                                        ...
                                        <td align="center" style="text-align:center;width:100%">
                                        	<asp:GridView ID="gvPosting" runat="server" style="width:100%" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Retirement Type" HeaderText="Retirement Type" />
                                                    ...
                                                    <asp:BoundField DataField="Relieve Request Date" 
                                                        HeaderText="Relieve Request Date" />
                                                    <asp:BoundField DataField="Relieve Accept Date" 
                                                        HeaderText="Relieve Accept Date" />
                                                </Columns>
                                            </asp:GridView>
                                        </td>
									</tr>
                                            ...
                                            <table style="width:100%; background-color:#F0E3C6" cellpadding="4px">
                                                <tr>
                                                    <th style="text-align:center; background-color:#847963; color:#FFFFFF;" colspan="2">
                                                        <asp:Label ID="lblRequest" runat="server">Retirement Request</asp:Label>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th class="style6" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align:left">
                                                        <asp:Button ID="btnSubReq" runat="server" Height="26px" 
                                                            onclick="btnSubReq_Click" Text="Submit Retirement Request" />
                                                    </td>
                                                </tr>
                                                <tr>
