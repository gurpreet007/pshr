<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_acc_leave_relieve.ascx.cs" Inherits="uc_acc_leave_relieve" %>
                                            ...
                                            <table style="width:100%; background-color:#F0E3C6" cellpadding="4px">
                                                <tr>
                                                    <th style="text-align:center; background-color:#847963; color:#FFFFFF;">
                                                        <asp:Label ID="lblRequest" runat="server">Accept Request</asp:Label>
                                                    </th>
                                                </tr>
                                            </table>
