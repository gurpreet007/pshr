<%@ Page Language="vb" AutoEventWireup="false" Inherits="pshr.resetpwd" CodeFile="resetpwd.aspx.vb" %>
														...
														<tr height="100%">
																<td valign="top" align="center">
																		<table class="CssBody" cellspacing="0" cellpadding="0" border="0" style=" HEIGHT: 133px">
																				<tr>
																						<td align="left">
																								<asp:label id="lMsg" runat="server" font-bold="True" forecolor="Red" visible="False"></asp:label></td>
																				</tr>
																				<tr>
																						<td>&nbsp;</td>
																				</tr>
																				...
																				<tr>
																						<td align="center" class="ContentBorder">
																								<table class="CssBody" cellspacing="10" cellpadding="0" border="0">
																										<tr>
																												<td align="left">Hello <b>
																																<%=strconv(Session("EmpNm"),3)%>
																														</b>
																												</td>
																												<td>&nbsp;</td>
																										</tr>
