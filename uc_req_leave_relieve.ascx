<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_req_leave_relieve.ascx.cs" Inherits="leave_request" %>
                                            ...
                                            <table style="width:100%; background-color:#F0E3C6" cellpadding="4px">
                                                <tr>
                                                    <th style="text-align:center; background-color:#847963; color:#FFFFFF;" colspan="2">
                                                        <asp:Label ID="lblRequest" runat="server">Leave Request</asp:Label>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th class="style6" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align:left">
                                                        <asp:Button ID="btnSubReq" runat="server" Height="26px" 
                                                            onclick="btnSubReq_Click" Text="Submit Leave Request" />
                                                    </td>
                                                </tr>
                                                <tr>
