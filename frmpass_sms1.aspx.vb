...
Partial Class _Default
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnreq.Click
        ...
        'Dim strUrl As String = "http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=Username:Password&senderID=mVaayoo&receipientno=" & lblmob.Text & "&msgtxt=Your Password is:" & pass & " .Change it after login&state=4"
        'Dim strUrl As String = "http://sms6.routesms.com:8080/bulksms/bulksms?username=pspctinternal&password=dfkbdfds&type=0&dlr=0&destination=" & lblmob.Text & "&source=PSPCL&message=Your password is:" & pass & ""
        Dim strUrl As String = "http://sms6.routesms.com:8080/bulksms/bulksms?username=pspclinternal&password=psc35int&type=0&dlr=1&destination=" & lblmob.Text & "&source=UPDATE&message=Your Password is:" & pass & ""
        ...
        Try
            ...
            If Mid(dataString, 1, 4) = "1701" Then
                sql = "begin "
                sql &= "insert into pshr.pass_req values(" & txtid.Text & ",sysdate);"
    ...
    Protected Sub btnmob_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnmob.Click
        ...
        ds.Dispose()
        ds = New DataSet
        sql = "select count(*) from pshr.pass_req where empid=" & txtid.Text
        orcn.FillData(sql, ds)
